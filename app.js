...
const Kidora = (() => {
  ...
  function adminPinLogin(event) {
    ...
    if (!admin) {
      admin = userRecord({ name: 'KIDORA Admin', email: 'admin@kidora.local', password: 'admin2026', role: 'admin', approved: true, avatar: '🛡️' });
  ...
  function deleteUser(id) {
    ...
    if (!confirm(`Delete ${u.name}? This removes local demo data for this user.`)) return;
  ...
  return {
    init, setAuthMode, login, adminPinLogin, register, quickDemo, go, logout,
